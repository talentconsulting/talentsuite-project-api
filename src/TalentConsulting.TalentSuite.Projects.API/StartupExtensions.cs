...
using System.Text;
using TalentConsulting.TalentSuite.Projects.API.Endpoints;
...
public static class StartupExtensions
{
    ...
    public static void ConfigureServices(this IServiceCollection services, IConfiguration configuration, bool isProduction)
    {
        ...
        services.AddTransient<MinimalSowEndPoints>();
    ...
    private static async Task RegisterEndPoints(this WebApplication app)
    {
        ...
        var sowsApi = scope.ServiceProvider.GetService<MinimalSowEndPoints>();
        sowsApi?.RegisterSowEndPoints(app);
